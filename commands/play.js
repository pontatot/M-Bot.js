const { SlashCommandBuilder, SlashCommandChannelOption, ChannelType, SlashCommandStringOption, EmbedBuilder } = require('discord.js');
...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption(new SlashCommandStringOption().setName('url').setDescription('music url or keywords').setRequired(true))
